...
for df in id_list:
    ...
    globals() [f'query_{df}'] = run_query(f"""select pH, DO, Cond, Turb, Temp, NH4,NO3,ORP,COD,BOD,TSS,logTime as NH3_N,logDate, logTime from Ma.Sensor where Station={int(ID)} order by logDate""")
